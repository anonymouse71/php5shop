...
<div>
   <p>
   Группа <input id="g<?php echo $item->id;?>" type="text" size="50" value="<?php echo $item->name;?>"> скидка <input type="text" size="5" value="<?php echo 100*(1-$item->pct);?>">%
...
<form method="post" action="<?php echo url::base()?>ajax/groups/1">
    <p>
        Добавить <input type="text" size="50" name="name"> со скидкой <input type="text" size="5" name="pct" value="0.00">
