...
<table border="0" class="ordhd">
    <tr>
        <td width="350px;"><b>Название</b></td><td width="20px;">&nbsp;</td><td><b>Цена</b></td><td width="20px;">&nbsp;</td><td><b>Количество</b></td><td width="20px;">&nbsp;</td><td width="20px;">&nbsp;</td><td></td>
    </tr>
...
<?php foreach($products as $item):?>
    <tr class="post">
        ...
        <td></td>
        <td><img class="imgcart" alt="Убрать из корзины" width="25" height="29" src="images/x.png" name="<?php echo $item['id'];?>"></td>
    </tr>
...
<br><br>
<a href="order" class="ordhd"><strong>Перейти к оформлению заказа</strong></a>
<?php endif;?>
