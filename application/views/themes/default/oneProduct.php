...
<div class="item left70" id="n<?php echo $item['id'];?>" style="margin-right: 100%; margin-bottom: 5px;" >
    ...
    <img align="left" src="<?php echo file_exists($pathImg)? $urlImg : url::base().'images/no-photo.jpg';?>" alt="<?php echo $item['name'];?>" >
    ...
    <a itemprop="url" href="<?php echo Model_Product::getProdUri($item['path']) ?>" class="name">
