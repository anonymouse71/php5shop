...
.topblock2 #CartItems{color:#3288A2}
#about{
width:517px;
padding:0 0 0 5px;
float:left;
...
/* Container */
#simplemodal-container {height:220px; width:300px; color:#bbb; background-color:#333; border:4px solid #444; padding:12px;}
...
#showHeaderCompare{ color:red; text-align: center; }
</style>