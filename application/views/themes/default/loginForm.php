...
<div style="width: 370px;margin: 2px;float: left;">
    ...
    <div id="uLogin"
         data-ulogin="display=panel;fields=first_name;providers=facebook,google,vkontakte,odnoklassniki,yandex,twitter,mailru;hidden=;redirect_uri=http%3A%2F%2F<?php echo $_SERVER['HTTP_HOST'], urlencode(url::base()); ?>login"></div>
</div>