 ...
 */
    public function action_config()
    {
        ...
        $menu[1] = (isset($_POST['menu1']))? 1 : 0;
        $menu[2] = (isset($_POST['menu2']))? 1 : 0;
        $menu[3] = (isset($_POST['menu3']))? 1 : 0;
        $menu[4] = (isset($_POST['menu4']))? 1 : 0;
        $menu[5] = (isset($_POST['menu5']))? 1 : 0;
        $menu[6] = (isset($_POST['menu6']))? 1 : 0;
        $menu[7] = (isset($_POST['menu7']))? 1 : 0;
        $menu[8] = (isset($_POST['menu8']))? 1 : 0;
        ...
        Model::factory('config')->setBool('ShowBlog',isset($_POST['ShowBlog'])?1:0);
        Model::factory('config')->setBool('timeFooter',isset($_POST['timeFooter'])?1:0);
        Model::factory('config')->setBool('poll',isset($_POST['poll'])?1:0);
        Model::factory('config')->setBool('regOrder',isset($_POST['regOrder'])?1:0);
        Model::factory('config')->setBool('comments',isset($_POST['comments'])?1:0);
        Model::factory('config')->setBool('invite',isset($_POST['invite'])?1:0);
