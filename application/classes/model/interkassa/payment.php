 ...
 * {@link Model_Interkassa_Payment::getFormValues() getFormValues() method}.
 *
 * @license MIT-style license
 * @package Interkassa
 * @author Anton Suprun <kpobococ@gmail.com>
 ...
 * @version 2.0.0
 */
class Model_Interkassa_Payment
{
    /**
     * Shop instance
     *
     * @var Model_Interkassa_Shop
     */
    protected $_shop;
     ...
     * @var string
     */
    protected $_success_method = Model_Interkassa::METHOD_POST;
     ...
     * @var string
     */
    protected $_fail_method = Model_Interkassa::METHOD_POST;
     ...
     * @var string
     */
    protected $_status_method = Model_Interkassa::METHOD_POST;
     ...
     *
     * @param Model_Interkassa_Shop $shop
     * @param array $options
     * @internal param \Model_Interkassa_Shop $interkassa
     *
     * @see Model_Interkassa_Payment::__construct()
     *
     * @return Model_Interkassa_Payment
     */
    public static function factory(Model_Interkassa_Shop $shop, array $options)
    {
        return new Model_Interkassa_Payment($shop, $options);
    }
     ...
     *
     * @throws Model_Interkassa_Exception if any required options are missing
     */
    public function __construct(Model_Interkassa_Shop $shop, array $options)
    {
        $this->_shop = $shop;

        if (!isset($options['id']))
        {
            throw new Model_Interkassa_Exception('Payment id is required');
        }

        if (!isset($options['amount']))
        {
            throw new Model_Interkassa_Exception('Payment amount is required');
        }

        if (!isset($options['description']))
        {
            throw new Model_Interkassa_Exception('Payment description is required');
        }
     ...
     *
     * @return Model_Interkassa_Payment self
     */
     ...
     *
     * Returns {@link Model_Interkassa::METHOD_POST}, {@link Model_Interkassa::METHOD_GET}
     * or {@link Model_Interkassa::METHOD_LINK}
     *
     * @return string
     */
     ...
     * @param string $method
     *
     * @uses Model_Interkassa::METHOD_POST
     * @uses Model_Interkassa::METHOD_GET
     * @uses Model_Interkassa::METHOD_LINK
     *
     * @return Model_Interkassa_Payment self
     */
    public function setSuccessMethod($method)
    {
        ...
        $methods = array(
            Model_Interkassa::METHOD_POST,
            Model_Interkassa::METHOD_GET,
            Model_Interkassa::METHOD_LINK
        );
     ...
     *
     * Returns {@link Model_Interkassa::METHOD_POST}, {@link Model_Interkassa::METHOD_GET}
     * or {@link Model_Interkassa::METHOD_OFF}
     *
     * @return string
     */
     ...
     * @uses Model_Interkassa::METHOD_POST
     * @uses Model_Interkassa::METHOD_GET
     * @uses Model_Interkassa::METHOD_OFF
     *
     * @return Model_Interkassa_Payment self
     */
     ...
     *
     * @uses Model_Interkassa_Payment::getAmountAsString() to form payment amount value
     *
     * @return array
     */
